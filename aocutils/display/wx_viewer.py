...
class Wx3dViewer(wx.Panel):
    ...
    def __init__(self,
        ...
        c_occ = colour_wx_to_occ(viewer_background_color)
        self.viewer_display.View.SetBackgroundColor(c_occ)

        # tools
        self.tools_panel = wx.Panel(self, -1)
        tools_sizer = wx.BoxSizer(wx.HORIZONTAL)

        btn_view_left = self.create_bitmap_button(self.tools_panel,
                                                  "icons/left-16x16.png",
                                                  "Left view")
        btn_view_right = self.create_bitmap_button(self.tools_panel,
                                                   "icons/right-16x16.png",
                                                   "Right view")
        btn_view_top = self.create_bitmap_button(self.tools_panel,
                                                 "icons/top-16x16.png",
                                                 "Top view")
        btn_view_bottom = self.create_bitmap_button(self.tools_panel,
                                                    "icons/bottom-16x16.png",
                                                    "Bottom view")
        btn_view_front = self.create_bitmap_button(self.tools_panel,
                                                   "icons/front-16x16.png",
                                                   "Front view")
        btn_view_back = self.create_bitmap_button(self.tools_panel,
                                                  "icons/back-16x16.png",
                                                  "Rear view")
        btn_view_iso = self.create_bitmap_button(self.tools_panel,
                                                 "icons/iso-16x16.png",
                                                 "Iso view")
        ...
        btn_view_hlr = self.create_bitmap_button(self.tools_panel,
                                                 "icons/hlr-16x16.png",
                                                 "Hidden Line Removal")
        btn_view_shaded = self.create_bitmap_button(self.tools_panel,
                                                    "icons/shaded-16x16.png",
                                                    "Shaded")
        ...
        self.Bind(wx.lib.colourselect.EVT_COLOURSELECT,
                  self.on_set_background_color,
                  colour_select)
    ...
    def display_message(self,
        ...
        """
        self.viewer_display.DisplayMessage(point,
                                           text_to_write,
                                           height,
                                           message_color,
                                           update)
