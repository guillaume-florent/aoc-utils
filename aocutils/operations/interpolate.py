...
def points_vectors(list_of_points,
                   list_of_vectors,
                   vector_mask=None,
                   tolerance=OCCUTILS_DEFAULT_TOLERANCE):
    r"""Build a curve from a set of points and vectors the vectors
    describe the tangent vector at the corresponding point
